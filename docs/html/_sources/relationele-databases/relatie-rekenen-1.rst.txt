...
`Binder-opdracht <https://mybinder.org/v2/gh/infvo/ieni2018-db/master?filepath=python-sqlite.ipynb>`_.
Je kunt in het notebook je eigen aanpassingen maken, en "spelen" met de data en de database-opdrachten.

De broncode van het notebook vind je op GitHub, zie
zie: `python-sqlite.ipynb op GitHub <https://github.com/infvo/ieni2018-db/blob/master/python-sqlite.ipynb>`_
